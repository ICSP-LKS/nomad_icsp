...
This is the NOMAD Oasis distribution of ICSP-LKS.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ICSP-LKS/nomad_icsp.git
    cd nomad_icsp
    ```
    ...
    ```sh
    curl-L -o nomad_icsp.zip "https://github.com/ICSP-LKS/nomad_icsp/archive/main.zip"
    unzip nomad_icsp.zip
    cd nomad_icsp
    ```
